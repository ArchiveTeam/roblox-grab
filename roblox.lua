...
allowed = function(url, parenturl)
  ...
  if string.match(url, "^https?://forum%.roblox%.com/Forum/ShowPost%.aspx%?PostID=[0-9]+$")
     and (parenturl == nil or string.match(parenturl, "^https?://forum%.roblox%.com/Forum/ShowForum%.aspx%?ForumID=[0-9]+&PageIndex=[0-9]+$")) then
    return true
  end

  if string.match(url, "^https?://forum%.roblox%.com/Forum/ShowPost%.aspx%?PostID=[0-9]+&PageIndex=[0-9]+$")
     and (parenturl == nil or string.match(parenturl, "^https?://forum%.roblox%.com/Forum/ShowPost%.aspx%?PostID=[0-9]+$")) then
    return true
  end
...
wget.callbacks.download_child_p = function(urlpos, parent, depth, start_url_parsed, iri, verdict, reason)
  ...
  if string.match(url, "&amp;") or string.match(url, "/Thumbs/") then
    return false
  end
...
wget.callbacks.get_urls = function(file, url, is_css, iri)
  ...
  if allowed(url, nil)  then
    ...
    if string.match(url, "^https?://forum%.roblox%.com/Forum/ShowPost%.aspx%?PostID=[0-9]+$") then
